...
$status = [ordered]@{
    ...
    kioskConsoleSessionId = $kiosk.ConsoleSessionId
    kioskSessionAligned = $kiosk.SessionAligned
    kioskProcessSessionIds = @($kiosk.ProcessSessionIds)
    kioskHasWrongSessionProcess = $kiosk.HasWrongSessionProcess
