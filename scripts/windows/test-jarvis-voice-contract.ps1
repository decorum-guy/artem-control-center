...
PANEL_JARVIS_VOICE_MODEL_ROOT=MODEL_ROOT
PANEL_JARVIS_WAKE_MODEL=WAKE_MODEL
PANEL_JARVIS_STT_MODEL=STT_MODEL
...
'@
    $runtimeEnvContents.Replace("MODEL_ROOT", $models).Replace("WAKE_MODEL", $wake).Replace("STT_MODEL", $stt) |
