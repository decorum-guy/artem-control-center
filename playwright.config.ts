...
export default defineConfig({
  ...
  webServer: {
    command: `PANEL_AGENT_RELOAD=false PANEL_WRITES_ENABLED=true PANEL_OVERVIEW_LAYOUT_WRITES_ENABLED=${overviewLayoutWritesFlag} PANEL_OVERVIEW_LAYOUT_PATH=${overviewLayoutPath} PANEL_COFFEE_TIMING_WRITES_ENABLED=true PANEL_COFFEE_NOTIFICATION_WRITES_ENABLED=true PANEL_COFFEE_ACTIONS_ENABLED=true PANEL_PLANNING_ENABLED=true PANEL_PLANNING_BASE_URL=http://fixture.test PANEL_PLANNING_INTERNAL_SECRET=synthetic-internal-secret PANEL_PLANNING_SECRET=synthetic-panel-agent-secret PANEL_PLANNING_FIXTURE_SCENARIO=${planningFixtureScenario} PANEL_PLANNING_REMINDER_MUTATIONS_ENABLED=${planningReminderMutationsFlag} PANEL_PLANNING_TASK_MUTATIONS_ENABLED=${planningTaskMutationsFlag} VITE_V2_VISUAL_SHELL=${visualShellFlag} VITE_OVERVIEW_V2_ENABLED=${overviewV2Flag} VITE_OVERVIEW_EDITOR_ENABLED=${overviewEditorFlag} VITE_PLANNING_OVERVIEW_ENABLED=${planningOverviewFlag} VITE_PLANNING_TASKS_ROUTE_ENABLED=${planningTasksFlag} VITE_PLANNING_CALENDAR_ROUTE_ENABLED=${planningCalendarFlag} VITE_PLANNING_REMINDERS_ROUTE_ENABLED=${planningRemindersFlag} VITE_PLANNING_REMINDER_MUTATIONS_ENABLED=${planningReminderMutationsFlag} VITE_PLANNING_TASK_MUTATIONS_ENABLED=${planningTaskMutationsFlag} npm run dev:fixtures`,
