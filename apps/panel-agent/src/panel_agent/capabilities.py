...
CAPABILITY_REGISTRY: tuple[CapabilityDefinition, ...] = (
    ...
    CapabilityDefinition("home_assistant_maintenance", "Обслуживание Home Assistant", "Разрешение перезапускать и обновлять Home Assistant через фиксированные системные действия.", "Системные действия", "PANEL_HA_MAINTENANCE_ACTIONS_ENABLED", "immediate", "none"),
