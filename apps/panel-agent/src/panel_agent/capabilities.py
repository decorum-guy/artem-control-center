...
CAPABILITY_REGISTRY: tuple[CapabilityDefinition, ...] = (
    ...
    CapabilityDefinition("planning_provider_calendar_mutations", "Запись календарей провайдера", "Разрешение Panel Agent изменять события и календари iCloud через AliceTG_Bot.", "Планирование", "PANEL_PLANNING_PROVIDER_CALENDAR_MUTATIONS_ENABLED", "immediate", "none"),
