...
class IntegrationSettings:
    ...
    panel_planning_provider_calendar_mutations_enabled: bool = False
    ...
    def from_env(cls) -> "IntegrationSettings":
        settings = cls(
            ...
            panel_planning_provider_calendar_mutations_enabled=_bool_env(
                "PANEL_PLANNING_PROVIDER_CALENDAR_MUTATIONS_ENABLED",
                False,
            ),
