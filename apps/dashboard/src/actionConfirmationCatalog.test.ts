...
describe("action confirmation catalog", () => {
  ...
  it("marks panel shutdown and diary deletions as non-waivable confirmations", () => {
    ...
    expect(mandatory).toEqual(["system.runtime.shutdown", "system.home_assistant.restart", "system.home_assistant.update_core", "settings.projects.delete", "coffee-diary.bean.delete", "coffee-diary.extraction.delete"]);
  });
});
